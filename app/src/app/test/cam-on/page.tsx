...
export default function PublicTestThankYouPage() {
  return (
    <main className="mx-auto flex min-h-screen max-w-xl flex-col items-center justify-center p-6">
      <div className="w-full rounded-lg border border-success-bg bg-white p-8 text-center shadow-sm">
        <CheckCircle2 className="mx-auto h-12 w-12 text-success-fg" aria-hidden />
        <h1 className="mt-4 text-xl font-semibold text-success-fg">{t.assessment.publicThanks}</h1>
