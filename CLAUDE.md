...
| `candidates` | Candidate CRUD, CV upload (đơn + bulk 1-20 PDF, AI backfill ô trống), stage transitions, `dossier.ts` — buildCandidateDossier: MD hồ sơ lắp TƯƠI (view, không store — ADR 0017) | — |
